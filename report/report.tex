...
\begin{itemize}
    ...
    \item \textbf{Score Weights:} The choice of weights was somewhat arbitrary. But similar results were obtained with the following different choices of weights: Factual(0.7, 0.1, 0.2), Robustness(0.4, 0.3, 0.3)
\end{itemize}
